const modulesEn = [
  ...
  },
  {
    ...
    quiz: [
      { question: 'What is the minimum voting age in India?', options: ['16 years', '18 years', '21 years', '25 years'], correctIndex: 1 },
      { question: 'Which form is used to register as a new voter in India?', options: ['Form 1', 'Form 6', 'Form 8', 'Form 11'], correctIndex: 1 },
      { question: 'What is EPIC in the context of Indian elections?', options: ['Electronic Polling Integration Card', 'Electors Photo Identity Card', 'Election Process Information Certificate', 'Electoral Participation ID Card'], correctIndex: 1 }
    ]
  },
  {
    id: 'laws',
    ...
    quiz: [
      { question: 'Which Article of the Indian Constitution establishes the Election Commission?', options: ['Article 14', 'Article 21', 'Article 324', 'Article 370'], correctIndex: 2 },
      { question: 'What does the Model Code of Conduct (MCC) regulate?', options: ['Taxation during elections', 'Behavior of parties and candidates during election period', 'Salaries of election officials', 'Foreign policy during elections'], correctIndex: 1 },
      { question: 'Which Act deals with the conduct of elections and corrupt practices in India?', options: ['Right to Information Act, 2005', 'Representation of the People Act, 1951', 'Indian Penal Code, 1860', 'Companies Act, 2013'], correctIndex: 1 }
    ]
  },
  {
    id: 'campaigns',
    ...
    quiz: [
      { question: 'How long before polling must campaigning stop in India?', options: ['12 hours', '24 hours', '48 hours', '72 hours'], correctIndex: 2 },
      { question: 'What is the current election expenditure limit for a Lok Sabha constituency?', options: ['₹25 lakh', '₹50 lakh', '₹70 lakh', '₹95 lakh'], correctIndex: 3 }
    ]
  },
  {
    id: 'voting',
    ...
    quiz: [
      { question: 'What does EVM stand for in Indian elections?', options: ['Electronic Vote Manager', 'Electronic Voting Machine', 'Electoral Verification Module', 'Election Validity Mechanism'], correctIndex: 1 },
      { question: 'What is the purpose of VVPAT in the voting process?', options: ['To speed up counting', 'To allow voters to verify their vote on a paper slip', 'To store voter photos', 'To connect EVMs to the internet'], correctIndex: 1 },
      { question: 'Why is indelible ink applied to a voter\'s finger?', options: ['For decoration', 'To prevent duplicate voting', 'To track voters via GPS', 'It is optional and not required'], correctIndex: 1 }
    ]
  },
  {
    id: 'results',
    ...
    quiz: [
      { question: 'How many Lok Sabha seats are needed for a majority to form the government?', options: ['200', '250', '272', '300'], correctIndex: 2 },
      { question: 'What is counted first on counting day in Indian elections?', options: ['EVM votes', 'Postal ballots', 'VVPAT slips', 'NOTA votes'], correctIndex: 1 },
      { question: 'How many VVPAT slips are verified per constituency as per Supreme Court orders?', options: ['1 booth', '3 booths', '5 booths', '10 booths'], correctIndex: 2 }
    ]
  }
];
