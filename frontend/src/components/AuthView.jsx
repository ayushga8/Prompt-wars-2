        ...
        <div className="auth-box">
          ...
          {step === 'email' ? (
            <div className="email-step">
              ...
              <input className="input-field" type="email" placeholder="Enter your email address" value={email} onChange={e => setEmail(e.target.value)} />
              <button className="btn primary-btn" onClick={handleSendOtp} disabled={loading}>
            ...
            <div className="otp-step">
              ...
              <input className="input-field" placeholder="Enter 6-digit OTP" maxLength={6} value={otp} onChange={e => setOtp(e.target.value)} />
              <button className="btn success-btn" onClick={handleVerifyOtp} disabled={loading}>
                {loading ? 'Verifying...' : 'Verify OTP'}
              </button>
              <button className="text-btn" onClick={() => setStep('email')}>← Back</button>
            </div>
          )}
        </div>
